    ...
    <main class="student-lessons">
        <section class="inner">
            ...
            <div class="block private-less">
                ...
                <div class="block__elem block__elem--content">
                    <?php foreach ($result as $item):
                        if (($item['name'] === $_SESSION['name']) and $item['type'] === 'private'):
                            $arr = explode('.', $item['day']);
                            $arr[1] = $monthes[+$arr[1] - 1]; ?>
                            <div class="content-elem"><?= $arr[0] . ' ' . $arr[1] . ' ' . $item['time'] ?></div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="block s-club-less">
                ...
                <div class="block__elem block__elem--content">
                    <?php foreach ($result as $item):
                        if (($item['name'] === $_SESSION['name']) and $item['type'] === 's-club'):
                            $arr = explode('.', $item['day']);
                            $arr[1] = $monthes[+$arr[1] - 1]; ?>
                            <div class="content-elem"><?= $arr[0] . ' ' . $arr[1] . ' ' . $item['time'] ?></div>
                        <?php endif; ?>
